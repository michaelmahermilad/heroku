...
const schema = yup.object({
  ...
  cfpassword: yup.string().required('No password provided.').oneOf([yup.ref('password'), null], 'Passwords must match') 
  .min(8, 'Short Password - should be 8 chars min.')
  .matches(/[a-zA-Z]/, 'Password can only contain Latin letters.'),
}).required();
                 ...
                 InputProps={{
                   endAdornment: (
                     ...
                     <IconButton
                       ...
                       onMouseDown={handleMouseDownPassword}
                     >
                       {values.showcfPassword ? <VisibilityOff sx={{color:'red'}}/> : <Visibility sx={{color:'grey'}}/>}
                     </IconButton>
                   </InputAdornment>
                   ),
                 }}
