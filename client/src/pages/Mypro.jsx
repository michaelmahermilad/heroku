...
const funct=()=>{
  ...
  return (
    <div style={{ marginTop: "3rem",backgroundColor:'white',width:'95%',margin:'auto' }} className="col-md-12 ">
      <div style={{display:'flex',alignItems:'flex-start'}} className='profileContainer'>
      
            <div   class="wrapper">
              <div class="container55">
                <img src={Prof} alt="" class="profile-img" />
                ...
                <button className="change55">Edit Password</button>
              </div>
            </div>
        ...
        <div  className="secondwrapper">
            ...
            <form   onSubmit={funct} className="formaaa">
           
            <div className="back55">
              ...
              <ul style={{ width: "100%" }} className="form_fields">
                ...
                <div style={{display:'flex',justifyContent:'space-between'}} className="col-12">
...
minLength="4"
      ...
      <div>
             ...
             <div >
             <select    required className="inpt55" id="id_gov" name="id_gov">
             <option selected disabled>-- Select Country Code</option>

{countriesarr.map((i,k)=>(
  <option style={{color:'black'}}  value={i.phone}>+({i.phone}) {i.name}</option>
))}
             ...
             <div>
                  ...
                  <select       className="inpt55" id="id_gov" name="id_gov">
                  <option  style={{color:'black'}} selected disabled>-- Select Governorate</option>
<option style={{color:'black'}}   value="الغربية">الغربية</option>
<option style={{color:'black'}}   value="الجيزة">الجيزة  </option>
<option   style={{color:'black'}}  value="الإسماعيلية">الإسماعيلية</option>
<option style={{color:'black'}}   value="كفر الشيخ">كفر الشيخ</option>
<option style={{color:'black'}}  value="مطروح">مطروح</option>
<option  style={{color:'black'}}  value="المنيا">المنيا</option>
<option style={{color:'black'}}  value="المنوفية">المنوفية</option>
<option  style={{color:'black'}}   value="الوادي الجديد">الوادي الجديد</option>
<option  style={{color:'black'}}  value="شمال سيناء">شمال سيناء</option>
<option style={{color:'black'}}  value="بورسعيد">بورسعيد</option>
<option  style={{color:'black'}}  value="القليوبية">القليوبية</option>
<option  style={{color:'black'}} value="قنا">قنا</option>
<option style={{color:'black'}}  value="البحر الأحمر">البحر الأحمر</option>
<option style={{color:'black'}}  value="الشرقية">الشرقية</option>
<option  style={{color:'black'}}  value="سوهاج">سوهاج</option>
 
<option  style={{color:'black'}} value="الأقصر">الأقصر</option>
<option style={{color:'black'}}  value="القاهرة">القاهرة</option>
<option  style={{color:'black'}} value="الإسكندرية">الإسكندرية</option>
 
<option  style={{color:'black'}} value="الدقهلية">الدقهلية</option>
<option style={{color:'black'}}  value="دمياط">دمياط</option>
</select>
             </div>    
               ...
               <div>
                ...
                <label for="phone">Enter your phone number:</label>
                  ...
                  <input className="inpt55" type="number" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"/>
                     </div> 
            <div></div>
                  <label >
