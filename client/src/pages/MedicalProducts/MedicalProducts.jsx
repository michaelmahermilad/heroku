...
useEffect(()=>{
  ...
  return (
    <div style={{backgroundColor:"#fafafa", width: "100vw", overflow: "hidden" }}>
     <NavBAR funct={funct} setR={setR}  pro={productList} />
      <Categories />
      { productDetails.loading?(<div style={{width:'fit-conetent',margin:'auto'}}>
        <div style={{width:'fit-content',display:'flex',flexDirection:'column',alignItems:'center',padding:'6rem 0',margin:'auto'}}>
      ...
      (<>
      <div style={{width:'fit-content',display:'flex',flexDirection:'column',alignItems:'center',margin:'auto'}}>
 ...
 <Product product={productDetails} />
      ...
      >
        {loading ? (
          ...
          <>
            { 
         (keyword!=="" && r=='start') ? products?.products?.map((i) =>(
