...
const issmall2 = useMediaQuery({ query: "(max-width: 900px)" });
  return (
    <>
    <div style={{width:'100%',borderLeft:'1rem solid #8b5400',borderRight:'1rem solid #8b5400', paddingBottom:'1rem', backgroundColor:'#1e1f2107',paddingTop:'1rem'}}>
      <Heading
        style={{
...
return (<>
  ...
  <SwiperSlide
           ...
           >
             {({ isActive }) => (
               <Card  >
               <img alt="" className="imageSwipper"
                   src={swippertest}
                  />
